...
{
	?>
	<h1 style="margin-left: 2.5vw;">Sold Products</h1>
		...
		<div class="card d-block d-sm-inline" style="max-width: 400px;">
		 <a href="<?php echo $d['img']?>"> <img src="<?php echo $d['img']?>" class="card-img-top" alt="..." width="50px" height="50px"></a>
		  <div class="card-body">
		    ...
		    <p class="card-text"><h4 style="display: inline;">Seller Email:<?php echo $d['seller'];?></h4></p>

		    <?php
		    $r = "SELECT * FROM register WHERE email = '".$d["buyer"]."' ";
		    $rs = mysqli_query($conn,$r);
		    $dx = mysqli_fetch_assoc($rs);
		    ?>
		    <p class="card-text"><h4 style="display: inline;">Buyer Details:</h4></p>
		    ...
		    <p class="card-text"><h4 style="display: inline;">Mobile:<?php echo $dx['mno'];?></h4></p>
		...
		<div class="card d-block d-sm-inline" style="max-width: 400px;">
		 <a href="<?php echo $d['img']?>"> <img src="<?php echo $d['img']?>" class="card-img-top" alt="..." width="50px" height="50px"></a>
		  <div class="card-body">
		    ...
		    $dx = mysqli_fetch_assoc($rs);
		    ?>
 <p class="card-text"><h4 style="display: inline;">Buyer Name:<?php echo $dx['fname']." ".$dx['lname'];?></h4></p>
		    <p class="card-text"><h4 style="display: inline;">Buyer Email:<?php echo $d['buyer'];?></h4></p>
		    <p class="card-text"><h4 style="display: inline;">Buyer Mobile:<?php echo $dx['mno'];?></h4></p>
		    <p class="card-text"><h4 style="display: inline;">Buyer Address:<?php echo $dx['ad'];?></h4></p>
		  </div>
		  </div>
			</form>
	<?php
...
{
?>
	<h1 style="margin-left: 2vw;"><?php echo "No products were sold by you" ?></h1>
	<?php
}
?>
</div>
